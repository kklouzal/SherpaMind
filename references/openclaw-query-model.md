...
- whether important retrieval metadata (category, cleaned subject, issue summary, next-step hints, follow-up/request-completion cues, confirmation/contract context, account-location and department context, intake-channel/handling flags, recent log types, resolution summary, attachment presence) is materially populated
